...
print("[cruix-music-archiver] defeating the evil invalid characters in /downloads... 🛡️⚔️")
...
print("[cruix-music-archiver] invalid characters obliterated successfully... ⚡ the cleanup force is strong! ✨")
